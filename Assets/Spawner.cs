...
public class Spawner : MonoBehaviour
{
    ...
    public float minSpawnTime = 0.5f; //Minimum amount of time bewteen spawning objects
    ...
    void Update()
    {
        ...
        if (timeSinceLastSpawn > timeToNextSpawn)
        {
            ...
            //The second paremeter in the brackets tells it where to spawn, so we've entered the position of the spawner
            //The thrid pareemeter is for the roationa and Quaternion.identity means no rotation
