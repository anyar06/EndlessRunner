...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Create a 'float' that will ve equal to the players horizontal input
        //float movementValueX = Input.GetAxis("Horizontal");

        //Set movementValueX to 1.0f, so that we always run forward and no longer care about player inpit
